define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'trp/goods_purchase/index' + location.search,
                    add_url: 'trp/goods_purchase/add',
                    edit_url: 'trp/goods_purchase/edit',
                    del_url: 'trp/goods_purchase/del',
                    multi_url: 'trp/goods_purchase/multi',
                    import_url: 'trp/goods_purchase/import',
