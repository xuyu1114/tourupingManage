define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'trp/goods/index' + location.search,
                    add_url: 'trp/goods/add',
                    edit_url: 'trp/goods/edit',
                    del_url: 'trp/goods/del',
                    multi_url: 'trp/goods/multi',
                    import_url: 'trp/goods/import',
                    table: 'goods',
                }
            });
